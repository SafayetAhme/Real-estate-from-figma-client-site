...
const StyJurny = () => {
    return (
        <div className='mt-24 mb-12 mx-auto overflow-y-scroll lg:px-24 bg-cover bg-fixed bg-center bg-no-repeat ' style={{ backgroundImage: `url(${ex})` }}>
            <div className='lg:flex container mx-auto justify-between items-center'>
                ...
                <form className='sm:py-0 lg:py-0 md:py-0 pb-16'>
                    <form>
