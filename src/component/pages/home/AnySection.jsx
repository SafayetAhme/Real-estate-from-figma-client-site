...
const AnySection = () => {
    return (
        <div className='text-center py-28 container mx-auto '>
            <div class="lg:text-[50px] font-poppins sm:text-[42px] md:text-[36px] text-[36px] lg:font-bold md:font-bold sm:font-bold  font-bold  text-center lg:leading-[64px] sm:leading-[60px] leading-[60px] ">Any Inquiry? Feel free <br /> To contact Us.</div>
