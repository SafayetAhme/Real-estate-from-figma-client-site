...
const Hero = () => {
    return (
        <div className="bg-[#FFF8F4] lg:pb-[155px] md:pb-[45px] sm:pb-[30px] pb-[18px] ">
            <div className='text-center lg:w-[1042px] mx-auto lg:pt-[101px] md:pt-[70px] sm:pt-[50px] pt-8'>
                <div class="lg:text-[76px] sm:text-[56px] md:text-[66px] text-[49px] lg:font-medium md:font-bold sm:font-bold  font-bold  text-center lg:leading-[80px] sm:leading-[60px] leading-[60px] ">Get the ideal home for <br /> your family</div>
