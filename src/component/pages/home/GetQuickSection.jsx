...
const GetQuickSection = () => {
    return (
        <div className='grid lg:grid-cols-2 container justify-center mx-auto items-center lg:gap-20 px-4 py-16'>
            <div>
                <img src={get} alt="" />
            </div>
            <div>
                <div className='text-[40px] font-bold pl-3 font-poppins'>
                    <h1 className='font-poppins text-lg font-normal text-gray-400'>CB ESTIMATE</h1>
                    <div class="font-poppins pt-2 leading-[54px] lg:text-5xl">Get quick estimate <br /> on your home.</div>
