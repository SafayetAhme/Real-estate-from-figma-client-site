        ...
        <div>
            ...
            <div className='container pb-4 mx-auto'>
                ...
                <div className="pt-16 pb-6">
                    <hr />
                    <div className='lg:flex justify-between py-3 items-center'>
                        ...
                        <div className='flex justify-center lg:pt-0 sm:pt-0 md:pt-0 pt-4 items-center gap-3'>
                            <h1>Share:</h1>
                                            ...
                                            project?.map(item =>
                                                <div key={item?.id} className="grid pb-12 lg:grid-cols-2 gap-16 items-center">
                                                    <div className="relative">
                                                        <img className="lg:w-full w-[400px] h-[440px]" src={item?.image} alt="" />
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-lg pt-4 font-poppins lg:w-[520px]">{item?.title}</p>
