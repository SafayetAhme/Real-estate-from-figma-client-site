                ...
                <div className="pt-16 pb-6">
                    ...
                    <div className='flex justify-between py-3 items-center'>
                        <div className='flex items-center gap-6'>
                            <button className='hover:bg-black hover:text-white px-4 py-1 rounded-lg'>All</button>
                            <button className='hover:bg-black hover:text-white px-4 py-1 rounded-lg'>APARTMENTS</button>
                            <button className='hover:bg-black hover:text-white px-4 py-1 rounded-lg'>HOUSE</button>
                            <button className='hover:bg-black hover:text-white px-4 py-1 rounded-lg'>VILLA</button>
                            <button className='hover:bg-black hover:text-white px-4 py-1 rounded-lg'>FLAT</button>
                        </div>
