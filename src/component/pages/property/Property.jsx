            ...
            <div className="grid lg:grid-cols-3 pt-10 container mx-auto">
                <div className='col-span-1 h-fit p-4' style={{ backgroundImage: `url(${probg})` }}>
                    <div className='bg-white rounded-2xl border-[2px] border-black'>
                        <div className='flex justify-between px-6 pt-6 -mb-3  items-end'>
                            <div className=''>
                        ...
                        <div className='flex justify-between px-6 pt-0 -mb-3  items-end'>
                            <div className=''>
                                <h1 className='text-lg font-normal text-gray-500'>Keywords</h1>
                                <h1 className='font-medium'>Apartments, Villa</h1>
                            </div>
                            <img className='' src="https://cdn.hugeicons.com/icons/arrow-down-01-stroke-rounded.svg" alt="arrow-down-01" width="28" height="28" />
                        </div>
                        <p className="divider px-6 divider-neutral"></p>
                        ...
                        <div className='flex justify-between px-6 pt-0 -mb-3  items-end'>
                            <div className=''>
                                ...
                                <h1 className='font-medium'>Washington DC</h1>
                            </div>
                            <img className='' src="https://cdn.hugeicons.com/icons/arrow-down-01-stroke-rounded.svg" alt="arrow-down-01" width="28" height="28" />
                        </div>
                        <p className="divider px-6 divider-neutral"></p>
                        ...
                        {/*  */}
                        <div className='grid lg:grid-cols-2 gap-12 items-center justify-between px-6'>
                            <div>
                                <div className='flex gap-9 w-full -mb-3 items-end'>
                                    <div className=''>
                                        <h1 className='text-lg font-normal text-gray-500'>Bedroom</h1>
                            ...
                            <div>
                                <div className='flex gap-[70px] w-full -mb-3 items-end'>
                                    <div className=''>
                                        <h1 className='text-lg font-normal text-gray-500'>Bath</h1>
                            ...
                            <div className='grid gap-3 pb-7 lg:grid-cols-2'>
                                <div>
                                    <div className='flex pt-4 items-center gap-2'>
                                        <input type="checkbox" name="radio-1" className="checkbox" />
                                    ...
                                    <div className='flex pt-4 items-center gap-2'>
                                        <input type="checkbox" name="radio-1" className="checkbox" />
                                        <h1 className='font-poppins text-[14px] font-medium'>Ceiling Height</h1>
                                    </div>
                                    <div className='flex pt-4 items-center gap-2'>
                                        <input type="checkbox" name="radio-1" className="checkbox" />
                                        <h1 className='font-poppins text-[14px] font-medium'>Elevator</h1>
                                    </div>
                                </div>
                                <div>
                                    <div className='flex pt-4 items-center gap-2'>
                                    ...
                                    <div className='flex pt-4 items-center gap-2'>
                                        <input type="checkbox" name="radio-1" className="checkbox" />
                                        <h1 className='font-poppins text-[14px] font-medium'>Fireplace</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className=' pb-6 px-6'>
                            <h1 className='font-poppins text-lg font-bold pb-2'>PRICE RANGE</h1>

                            <div className='flex pt-2 items-center'>
                                <div className='border-2 py-1 px-7 font-medium'>${values[0]}</div>
                                <div className='px-4'>-</div>
                                <div className='border-2 py-1 px-7 font-medium'>${values[1]}</div>
                                <div className='pl-4 font-medium'>USD</div>
                            </div>
                            ...
                            <Slider className="w-[100%] bg-slate-400 h-3 rounded-full mt-3"
                                onChange={setValues}
                                value={values}
                                min={MIN}
                                max={MAX}
                        ...
                        <div className='px-6 mb-6'>
                            ...
                            <div className='flex pt-2 items-center'>
                                <div className='border-[1px] py-2 w-full border-black rounded-lg text-center font-medium'>MIN</div>
                                <div className='px-4'>-</div>
                                <div className='border-[1px] py-2 w-full border-black rounded-lg text-center font-medium'>MAX</div>
                            </div>
                        </div>
                ...
                <div className='col-span-2 pl-12'>
                    ...
                    <div className='pt-4 grid lg:grid-cols-2 gap-5'>
                        <div className="relative flex w-full max-w-[23rem] flex-col rounded-2xl bg-white bg-clip-border text-gray-700 shadow-lg">
                            <div className="relative mx-3 mt-3 overflow-hidden text-white shadow-xl rounded-lg bg-blue-gray-500 bg-clip-border shadow-blue-gray-500/40">
                                ...
                                <button className="!absolute top-3 left-3">
                                    <span className="bg-[#FF6B2C] px-2 py-[4px] text-xs font-medium rounded-full pb-1">FOR RENT</span>
                                </button>
                            ...
                            <div className="p-5">
                                <h5 className="block font-sans text-xl text-[#FF6B2C] font-medium tracking-normal text-blue-gray-900">Wooden House, Florida</h5>
                                ...
                                <div className='flex pt-2 justify-between items-center'>
                                    <h1 className='text-[28px] font-bold font-poppins'>$33,000.00</h1>
