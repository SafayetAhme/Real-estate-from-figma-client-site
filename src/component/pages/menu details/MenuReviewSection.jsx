...
const MenuReviewSection = () => {
    ...
    // const [ratting, setRatting] = useState(menus);


    // // filter by ratting
    // const filterRatting = (cate) => {
    //     const filtercategory = menu?.filter(item => item?.rating === parseInt(cate));
    //     setRatting(filtercategory)
    // }
    ...
    return (
        <div className='bg-white shadow-lg rounded-xl mt-10 p-6'>
            ...
            {
                menu?.customerReview?.map(item =>
                    <div key={item.id} className='flex items-start pt-4 gap-3'>
                        <div className=''>
                        ...
                        <div>
                            ...
                            <p className='font-poppins leading-[22px] text-sm pt-4'>{item?.description}</p>
